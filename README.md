Author: Antonio Wendell Alves de sa
...
Exercícios (Cedidos gentilmente pelo Prof. Ricardo Satoshi) – Fazer em Python
    ...
    05. Receba os coeficientes A, B e C de uma equação do 2o grau (AX2+BX+C=0). Calcule e mostre as raízes reais (considerar que a equação possui 2 raízes reais).
